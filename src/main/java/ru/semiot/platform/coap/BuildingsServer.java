...
public class BuildingsServer extends CoapServer {
  ...
  public BuildingsServer(final int port, ConcurrentLinkedQueue<Building> buildings) {
    super(port);

    for (Building building : buildings) {
      BuildingResource buildingResource =
          new BuildingResource(String.valueOf(building.getBuildingNumber()));
      BuildingDescriptionResource bdr =
          new BuildingDescriptionResource(building.getDescription().toString());
